...
import { getFirestore, collection, doc, addDoc, getDoc, getDocs, setDoc, updateDoc, onSnapshot, query, where, orderBy, serverTimestamp, limit, startAfter, deleteDoc, runTransaction, getCountFromServer, getAggregateFromServer, average, count, sum } from "https://www.gstatic.com/firebasejs/11.0.0/firebase-firestore.js";
...
// ===== EXPORTS =====
export { db, auth, gProvider, collection, doc, addDoc, getDoc, getDocs, setDoc, updateDoc, onSnapshot, query, where, orderBy, serverTimestamp, limit, startAfter, deleteDoc, runTransaction, getCountFromServer, getAggregateFromServer, average, count, sum, createUserWithEmailAndPassword, signInWithEmailAndPassword, signOut, onAuthStateChanged, signInWithPopup, signInWithRedirect, getRedirectResult, sendPasswordResetEmail, isSignInWithEmailLink, signInWithEmailLink, sendSignInLinkToEmail };
