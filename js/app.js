...
function callCurrentStore(){ if(!window.currentStorePhone){showToast('رقم المتجر غير متاح','err');return;} callStore(window.currentStorePhone); }
function waCurrentStore(){ if(!window.currentStorePhone){showToast('رقم المتجر غير متاح','err');return;} openWA(window.currentStorePhone, window.currentStoreName||'المتجر'); }
...
Object.assign(window, {
  ...
  buildChart, callStore, callCurrentStore, waCurrentStore, chgQty, closeModal, custNav, delBanner, delCat, delCoupon, delProd,
  ...
  openAddCat, openAddCoupon, openAddProd, openAnyReq, openCart, removeCartItem, openDrvModal, openNotifs,
  ...
  dregNext, dregBack, dregSetExp, dregGetLocation, dregSaveDraft, dregInit, dregRestart,
  openTermsModal, closeTermsModal, agreeTermsModal, uploadDoc, removeUploadedDoc, zoomDoc, closeZoom,
  admLogoutConfirm, openReasonModal, closeReasonModal, confirmReasonModal, logAudit, loadAuditLog,
  filtOrds, openStoreManage, closeStoreManage, smTab, smSetOpen, smSaveProfile, smUploadLogo,
  smUploadCover, smDeleteCover, smSetAccountStatus, smDeleteStore, smQuickPause, smQuickActivate,
  openEditProd, saveEditProd, toggleProdAvail, admDelProd
});
